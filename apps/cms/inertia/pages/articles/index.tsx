...
export default function Index(props: Props) {
  return (
    <div className="w-full">
      <article className="relative w-full h-auto grid grid-row-start-1 grid-row-end-auto shadow-[0_0_0_1px_rgba(237,239,242,1),0_0_2px_0_rgba(0,0,0,0.12)] rounded-8px m-1px h-250px! overflow-x-auto">
        <div>
